...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "river@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Lap training, technique drills, and meets",
        "schedule": "Tuesdays and Thursdays, 5:00 PM - 6:30 PM",
        "max_participants": 18,
        "participants": ["lina@mergington.edu", "mark@mergington.edu"]
    },
    # Artistic activities
    "Art Club": {
    ...
    "Science Olympiad": {
        "description": "STEM challenges, lab work, and regional contests",
